...
# train_data = pd.read_csv('oversampled_data.csv')
train_data = pd.read_csv('undersampled_data.csv')
...
# output_csv_path = "../oversampled_processed_train_data.csv"
output_csv_path = "../undersampled_processed_train_data.csv"
