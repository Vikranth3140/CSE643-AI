...
y_train_pred = best_dt.predict(X_train)  # 'best_dt' is the tuned model from previous step
...
# Compute residuals for training and test datasets
train_residuals = y_train - y_train_pred
test_residuals = y_test - y_test_pred

# Report basic statistics of residuals
...
# Plot residuals vs. a key feature (e.g., Carpet_area)
plt.figure(figsize=(10, 6))
